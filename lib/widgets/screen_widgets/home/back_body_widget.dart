...
class BackBodyWidget extends StatefulWidget {
  const BackBodyWidget({super.key});

  @override
  State<BackBodyWidget> createState() => _BackBodyWidgetState();
}

class _BackBodyWidgetState extends State<BackBodyWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Stack(
        children: [
          Image.asset(
              'assets/back_image.png'), // Replace with your front body image
          Positioned(
